...
inline const char *EnumNameSparseTensorIndex(SparseTensorIndex e) {
  if (e < SparseTensorIndex::NONE || e > SparseTensorIndex::SparseTensorIndexCSF) return "";
  const size_t index = static_cast<size_t>(e);
...
struct SparseTensorIndexCSF FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  /// Each two consecutive dimensions in tensor correspond to an entry in
  /// indptrBuffers. Pairs of consecutive values in indptrBuffers[i] signify
  /// range of nodes in indicesBuffers[i + 1] that are children of
  /// indicesBuffers[i] nodes.
  ...
  /// Each tensor dimension corresponds to an entry in indicesBuffers.
  /// For example, the indicesBuffers for the above X is:
  ///
  ///   indicesBuffer(X) = [[0, 1], [0, 1, 1], [0, 0, 1, 1],
  ///                       [1, 2, 0, 2, 0, 0, 1, 2]].
  ///
